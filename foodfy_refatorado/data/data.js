module.exports = {
    ...
    index_texts: {
        h1_text: 'As melhores receitas',
        gray_text: 'Aprenda a construir os melhores pratos com receitas criadas por profissionais do mundo inteiro.',
        chef_alt: 'Imagem chef',
        footer_text: 'Todos direitos reservados, receitas Foodfy.'
    },

    about: [

        {
            title_description: 'Sobre o Foodfy',
            title_description2: 'Como tudo começou...',
            title_description3: 'Nossas receitas',
            text_1: 'suspendisse placerat neque neque. Morbi dictum nulla non sapien rhoncus, et mattis erat commodo. Aliquian vel lacus a justo mollis luctus. Proin vel auctor eros, sed eleifend nunc. Curabitur eget tincidunt risus. Mauris malesuada facilisis magna, vitae volutpat sapien tristique eu. Morbi metus nunc, interdum in erat placerat, aliquam iaculis massa. Duis vulputate varius justo pharetra maximus. In vehicula enim nec nibh porta tincidunt. Vestibulum at ultrices turpis, non dictum metus Vivamus ligula ex, semper vitae eros ut, euismod convallis augue.',
            text_2: 'Fusce nec pulvinar nunc. Duis portittor tincidunt accumsan. Quisque pulvinar mollis ipsum ut accumsan. Proin ligula lectus, rutrum vel nisl quis, efficitur porttitor nisl. Morbi ut accumsan felis, eu ultrices lacus. integer in tincidunt arcu, et posuere             ligula. Morbi cursus facilisis feugiat. Praesent euismod nec nisl at accumsan. Donec libero neque, vulputate semper orci et, malesuada sodales eros. Nunc ut nulla faucibus enim ultricies euismod.',
        },
    ],
