...
function criaVendas(transações) {
...
function PegaMaiorTransaçãoPorTipo() {
    let maiorTransaçãoCrédito = 0
    let maiorTransaçãoDinheiro = 0
    let maiorTransaçãoDébito = 0
    for (transações of sorveteria.vendas) {
        ...
        } else if (transações.tipo == 'dinheiro' && transações.valor > maiorTransaçãoDinheiro) {
            maiorTransaçãoDinheiro = maiorTransaçãoDinheiro + transações.valor
        } else {
            maiorTransaçãoDébito = maiorTransaçãoDébito + transações.valor
        }
    }
    return {
        crédito: maiorTransaçãoCrédito,
        dinheiro: maiorTransaçãoDinheiro,
        débito: maiorTransaçãoDébito
    }
}

function pegaTransaçãoMédia() {
    let soma = 0
